...
{
    public partial class FormRepListaCompra : Form
    {
        ...
        public FormRepListaCompra()
        {
            ...
            this.Name = "Lista de Compra";
            this.Text = "Produtos em Baixa";
        ...
        private void CarregarProdutos()
        {
            try
            {
                // Query para buscar os produtos com Quant_Atual <= 50
                string query = "SELECT Nome, Descricao, Preco, Quant_Atual FROM Produto WHERE Quant_Atual <= 50";
